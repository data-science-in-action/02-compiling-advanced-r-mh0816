...
```r
e1
#> <environment: 0x0000000012dc5208>
```
...
```r
env_parent(e2b)
#> <environment: 0x00000000197ef4e0>
env_parent(e2a)
...
```r
env_parents(e2b)
#> [[1]]   <env: 00000000197EF4E0>
#> [[2]] $ <env: global>
env_parents(e2d)
#> [[1]]   <env: 0000000019F97BC8>
#> [[2]] $ <env: empty>
```
...
plus_one
#> function(y) x + y
#> <environment: 0x00000000183c0f70>
```
