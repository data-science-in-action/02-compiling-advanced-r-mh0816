...
#>     x ^ exp
#>   }
#> <environment: 0x00000000154d6230>

cube
#> function(x) {
#>     x ^ exp
#>   }
#> <bytecode: 0x0000000013309bd8>
#> <environment: 0x000000001545f190>
```
...
```r
env_print(square)
#> <environment: 00000000154D6230>
#> parent: <environment: global>
#> bindings:
#>  * exp: <dbl>

env_print(cube)
#> <environment: 000000001545F190>
#> parent: <environment: global>
#> bindings:
#>  * exp: <dbl>
```
...
#> <bytecode: 0x0000000018bd7658>
#> <environment: 0x0000000018e4f518>
plot_dev("png")
#> function(...) grDevices::png(..., res = dpi, units = "in")
#> <bytecode: 0x0000000015e70278>
#> <environment: 0x00000000139bb4b0>
```
...
#>   }
#> <bytecode: 0x0000000013309bd8>
#> <environment: 0x00000000155a5d20>
```
