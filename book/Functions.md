...
getwd()
#> [1] "C:/Users/86130/Documents/Advanced R Programming"
with_dir("~", getwd())
#> [1] "C:/Users/86130/Documents"
```
...
1.  We can use `on.exit()` to implement a simple version of `capture.output()`.
    ...
    #> \Users\86130\AppData\Local\Temp\RtmpoF2dKc\file2a1059782dca'，原因
    #> 是'Permission denied'
    #> [1] "a" "b" "c"
    ```
