...
|memoise     |1.1.0      |CRAN (R 3.6.2)                 |
|png         |NA         |NA                             |
|profvis     |0.3.6      |CRAN (R 3.6.3)                 |
|Rcpp        |1.0.3      |CRAN (R 3.6.2)                 |
|rlang       |0.4.4      |CRAN (R 3.6.2)                 |
|rmarkdown   |2.1        |CRAN (R 3.6.3)                 |
|RSQLite     |2.2.0      |CRAN (R 3.6.3)                 |
|scales      |1.1.0      |CRAN (R 3.6.2)                 |
|sessioninfo |1.1.1      |CRAN (R 3.6.2)                 |
|sloop       |1.0.1      |Github (hadley/sloop\@0f39299) |
|testthat    |2.3.1      |CRAN (R 3.6.2)                 |
|tidyr       |1.0.2      |CRAN (R 3.6.3)                 |
|vctrs       |0.2.3      |CRAN (R 3.6.2)                 |
