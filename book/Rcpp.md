...
#> 1 sum(x)        1.6μs    2.1μs   385617.        0B     0   
#> 2 sumC(x)       2.2μs    4.3μs   203522.    2.49KB     0   
#> 3 sumR(x)      42.3μs   45.9μs    17594.   35.66KB     2.03
```
...
#>   expression          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 pdistR(0.5, y)   8.49ms   12.4ms      82.1    7.63MB     41.0
#> 2 pdistC(0.5, y)   7.83ms   9.16ms      98.1    7.63MB     33.8
```
...
#>   expression              min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 gibbs_r(100, 10)     4.44ms   5.24ms      172.    4.97MB     35.1
#> 2 gibbs_cpp(100, 10)  253.7μs  426.9μs     2140.     4.1KB     15.3
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 vacc1        2.01ms   2.83ms      308.    7.86KB    16.2 
#> 2 vacc2        74.1μs 115.25μs     8057.  153.14KB    21.2 
#> 3 vacc3        32.3μs   57.2μs    16174.   14.48KB     6.27
```
